...
topic_list = ['Food', 'Gaming', 'Politics', 'History', 'Aliens', 'Computers', 'I_Hate_Computers', 'Sports', 'Technology', 'News', 'Straight_Up_Being_Evil', 'Epic_Moments', 'Nice People :)', 'Music'] 
...
def insert_some_posts():
    ...
    for topic in topic_list:
        ...
        texts.append(f'The {topic} community is dying! Please repost and like and subscribe to make sure {topic} doesn\'t die out')
